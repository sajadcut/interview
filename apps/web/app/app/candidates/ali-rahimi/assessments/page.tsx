    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="mb-1 text-[10px] font-medium text-indigo-600">Candidate Intelligence · Assessments</div>
      ...
      <div className="grid gap-3 xl:grid-cols-[1.1fr_.9fr]">
        <Panel>
          ...
          <div className="grid gap-4 p-5 pt-4 md:grid-cols-[160px_1fr]">
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-[10px] border border-slate-100 bg-slate-50 p-3 text-[10px] leading-5 text-slate-500">
                Result data comes from a runner boundary. Candidate code is never executed inside the core NestJS API process.
              </div>
            </div>
          </div>
        </Panel>
        ...
        <Panel>
          ...
          <div className="space-y-2 p-5 pt-4">
            {[
              ["Database transaction handling", "assessment:test-group:transactions", "green"],
              ["Idempotent retry behavior", "assessment:test-group:retries", "green"],
              ["Race-condition mitigation", "assessment:test-group:concurrency", "blue"],
              ["Operational diagnostics", "review note · manual evidence", "amber"],
            ].map(([title, ref, tone]) => (
