  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <div className="mb-2 flex flex-wrap items-center gap-3"><span className="text-[10px] font-medium text-indigo-600">Senior Backend Engineer · Decision support</span><DemoNotice /></div>
      ...
      <div className="grid gap-3 xl:grid-cols-[1.05fr_.95fr]">
        <Panel>
          <SectionHeader title="Ali Rahimi · rubric v3" subtitle="Final score is calculated by weighted domain code after every required criterion has evidence." action={<Pill tone="amber">Human review pending</Pill>} />
          <div className="space-y-4 p-5 pt-4">
            {criteria.map((criterion) => (
              <div key={criterion.label} className="rounded-[11px] border border-slate-100 p-4">
                <div className="mb-3 flex items-center justify-between gap-3">
                  <div><div className="text-[12px] font-semibold text-slate-900">{criterion.label}</div><div className="mt-1 text-[10px] text-slate-500">{criterion.evidence} evidence references</div></div>
        ...
        <div className="space-y-3">
          <Panel>
            ...
            <div className="grid grid-cols-2 gap-3 p-5 pt-4">
              <div className="rounded-[11px] bg-emerald-50 p-4"><div className="text-[10px] font-medium text-emerald-700">Required criteria covered</div><div className="mt-2 text-[28px] font-semibold text-emerald-950">4 / 4</div></div>
              <div className="rounded-[11px] bg-indigo-50 p-4"><div className="text-[10px] font-medium text-indigo-700">Evidence references</div><div className="mt-2 text-[28px] font-semibold text-indigo-950">14</div></div>
            </div>
          </Panel>
          ...
          <Panel>
            ...
            <div className="space-y-3 p-5 pt-4 text-[11px] leading-5 text-slate-600">
              ...
              <div className="rounded-[10px] border border-slate-100 bg-slate-50 p-3 text-[10px] text-slate-500">Any override must preserve previous value, new value, reviewer, reason and timestamp.</div>
            </div>
          </Panel>
        </div>
      </div>
